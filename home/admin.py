...
from .models import Tesi, Attivita_progettuale, Richiesta_tesi, Richiesta_prova_finale,TesiArchiviata,Attivita_progettuale_Archiviata, Richiesta_tesi_inviata
